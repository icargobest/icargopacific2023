            ...
            <div class="card-body mx-2">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 mt-3">
                        ...
                        >
                            <table
                                class="table table-responsive table-sm table-borderless table-striped table-no-bottom-space table-borderless hover"
                                id="companyFreightTransfer"
                            >
                                <tbody>
                                    <tr>
                                        <th scope="row">ID:</th>
...
<script type="text/javascript">
    let companyFreightTransfer = new DataTable("#companyFreightTransfer");
</script>

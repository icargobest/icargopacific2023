...
@extends('layouts.app') @include('partials.navigationCompany',['freight' =>
"nav-selected"]) {{-- ORDER CONTAINER RECONCEPTUALIZE --}}
<div class="order-container container">
    <h4>FREIGHT LIST</h4>

    <div class="cards-holder">
        @foreach ($shipments as $ship) @if(Auth::user()->type == 'company')
        @if($company->id == $ship->company_id) {{-- && $ship->company_bid ==
        Auth::user()->name && $ship->status != 'Delivered' ||
        (Auth::user()->type == 'company' && $ship->company_bid ==
        Auth::user()->name && $ship->status == 'Transferred'))) --}} {{-- CARD
        CREATED AFTER FILLING UP --}}
                                ...
                                <div class="receiverInfo col-lg-6">
                                    ...
                                    <ul>
                                        <li>
                                            Name |
                                            <span
                                                >{{$ship->recipient->recipient_name}}</span
                                            >
                                        </li>
                                        <li>
                                            Address |
                                            <span
                                                ...
                                                ,
                                                {{$ship->recipient->recipient_zip}}</span
                                            >
                                        </li>
                                        <li>
                                            Number |
                                            <span
                                                ...
                                                @if($ship->recipient->recipient_tel
                                                != NULL) |
                            ...
                            <div class="parcelInfo-wrapper">
                                <div class="itemInfo">
                                    ...
                                    <div class="parcelDetails row">
                                        <div
                                            class="listLayout col-lg-6 col-sm-12"
                                        >
                                            <ul>
                                                <li>
                                                    ID |
        ...
        {{-- END OF CARD --}} @endif @endif @endforeach
    </div>
</div>

                                    ...
                                    @foreach ($logs as $log)
                                        @if ($ship->id == $log->shipment_id)
                                            <div class="row text-center pb-5">
                                                ...
                                                <div class="col-md-3">
                                                    <i class="fa fa-user-circle fa-2x" @if ($log->isPickUp != null) style="color:green" @endif></i>
                                                    <p>Pickup by Courier</p>
                                                </div>

                                                <!-- on the way -->
                                                <div class="col-md-3">
                                                    <i class="fa fa-truck fa-2x" @if ($log->isDispatched != null) style="color:green" @endif></i>
                                                    <p>On the way</p>
                                                </div>
                                                <!-- delivered -->
                                                <div class="col-md-3">
                                                    <i class="fas fa-clipboard-check fa-2x" @if ($log->isDelivered != null) style="color:green" @endif></i>
                                                    <p>Delivered</p>
                                                </div>
                                            </div>
                                        @endif
                                    @endforeach
                                    <div class="container align-item-center text-center mt-5">
                                        <div class="dropdownContainer mb-3 mt-5">
                                            <select
                                                class="form-select bold-hover border-black capitalized b-shadow s-margin modified-select"
                                                aria-label="Default select example" style=" max-width: 100%;">

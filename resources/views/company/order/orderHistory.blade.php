@extends('layouts.app') @include('partials.navigationCompany', ['history' =>
'nav-selected'])
        ...
        <div class="table-container">
            ...
            >
                ...
                <tbody class="history-tbody">
                    @foreach ($shipments as $shipment) @if (Auth::user()->type
                    == 'company') @if (Auth::user()->id ==
                    $shipment->company_id) @if ($shipment->status ==
                    'Delivered')
                    <tr>
                        <td>{{ $shipment->id }}</td>
                        <td>
                        ...
                        <td>
                            {{ intval($shipment->length) }}x{{
                            intval($shipment->width) }}x{{
                            intval($shipment->height) }} | {{

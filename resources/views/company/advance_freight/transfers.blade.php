...
<div class="content-containe mx-4 pt-4">
  <div class="main-wrapper border border-2" style=" max-width: 100%;">
      ...
      {{-- search bar, patanggal kung di na need --}}
      ...
      <div class="card-body mx-2">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6">
              ...
              <input type="hidden" name="transfer_from_company" value="{{Auth::user()->id}}">
                ...
                <div class="input-group pb-3">
                    <input type="date" id="shipping_date" class="form-control @error('shipping_date')is-invalid @enderror" placeholder="SHIPPING DATE" aria-label="Search" aria-describedby="search-addon" style="background-color: #EAEBEE"/>
                </div>
                <div class="input-group pb-3">
                ...
                <div class="input-group pb-3 ">
                  <input type="text" class="form-control" name="payment_method" value="{{$ship->mop}}" placeholder="{{$ship->mop}}"/>
                </div>
                <div class="input-group pb-3">
            ...
            <div class="col-sm-6 col-md-6 mt-3">
              ...
              <div class="div input-group rounded" style="width: 98% !important; height: 0% !important;">
                <div class="mt-1 ms-3">@include('flash-message')</div>
              </div>   

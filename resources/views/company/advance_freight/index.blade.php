            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    @foreach ($shipments as $ship)
                        @if (Auth::user()->type == 'company' && $ship->status != "Delivered")
                            @if ($company->id == $ship->company_id)
                                <tr>
                                    ...
                                    <td class="tdbutton" style="max-width:120px">
                                        @include('company.advance_freight.advance_tracking')
                                        ...
                                        @if ($ship->advTransferredStatus == null || $ship->advTransferredStatus == 'Rejected')
                                            <a href="{{ route('adv_Freight', $ship->id) }}"><button
                                        ...
                                        @include('company.advance_freight.print-modal')
                                </tr>
                            @endif
                        @endif
                    @endforeach
            ...
            <table class="table table-bordered table-striped">
                ...
                @foreach ($shipments as $ship)
                    @if (Auth::user()->type == 'company' &&
                            $ship->advTransferredto == Auth::user()->id &&
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/company/advFreight/accept', $ship->id) }}"
                                    class="btn btn-success">Accept</a>
                            </td>

                            <td>
                                <a href="{{ url('/company/advFreight/decline', $ship->id) }}"
                            ...
                            <div class="card mb-3" style="background-color: #D9D9D9;">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <h5 class="card-title border-0 fw-bold">AWAITING FOR COMPANY #:
                                            {{ $company_log->company_to }}
                            ...
                            <div class="card mb-3" style="background-color: #D9D9D9;">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <h5 class="card-title border-0 fw-bold">COMPANY #:
                                            {{ $company_log->company_to }}

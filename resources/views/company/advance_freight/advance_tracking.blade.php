...
<button type="button" class="btn created-button mx-auto" style="background-color: white; border-color:#214D94; color:black !important;" data-mdb-toggle="modal" data-mdb-target="#trackModal {{-- {{$ship->id}} --}}">
  Tracking
</button>

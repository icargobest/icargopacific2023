...
<button
    ...
    data-mdb-target="#restoreModal{{$company->id}}"
>
    Restore
</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form
                    method="POST"
                    action="{{route('companies.unarchive', $company->id)}}"
                >
                    @csrf @method ('PUT')
                    <h4>
                    ...
                    <p>
                        ...
                        company's account will also restore its employee
                        accounts.
                    </p>

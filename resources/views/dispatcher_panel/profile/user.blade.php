...
@extends('layouts.app') @include('partials.navigationDispatcher')
        ...
        <div class="profileTab">
            <div class="profileBackground1">
                <button
                    ...
                    data-bs-target="#editimage{{$dispatcher->id}}"
                >
                    <i class="fa fa-pencil"></i>
                </button>
                <div class="profilePicture">
                    <img
                        src="@if ($dispatcher->image != null) {{ asset('storage/images/dispatcher/'.$dispatcher->user_id.'/'.$dispatcher->image) }} @else /img/default_dp.png @endif"
                        height="100"
                        width="100"
                        alt=""
                    />
            ...
            <div class="profileContent">
                <div class="titleButton">
                    ...
                    <button
                        ...
                        style=""
                        data-bs-toggle="modal"
                        data-bs-target="#personalinfo{{$dispatcher->id}}"
                    >
                        EDIT
                    </button>
                </div>
            ...
            <div class="profileContent">
                ...
                <div class="profileInfoData">
                    <i class="fa fa-facebook" aria-hidden="true">
                        <span class="data-content"
                            ><a
                                href="{{ $dispatcher->facebook }}"
                                target="_blank"
                                >{{ $dispatcher->facebook ?? '-' }}</a
                            ></span
                        ></i
                    >
                    <i class="fa fa-linkedin" aria-hidden="true">
                        <span class="data-content"
                            ><a
                                href="{{ $dispatcher->linkedin ?? '-'}}"
                                target="_blank"
                                >{{ $dispatcher->linkedin ?? '-'}}</a
                            ></span
                        ></i
                    >
                </div>
...
@include('dispatcher_panel.profile.imagemodal') @include('partials.footer')

                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <p class="card-text mb-0">Date :
                                                                {{ date('F d, Y h:i A', strtotime($log->isDeliveredTime)) }}
                                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <h5 class="card-title border-0 fw-bold">YOUR ORDER IS OUT
                                                                FOR DELIVERY</h5>
                                                            <p class="card-text mb-0">Date :
                                                                {{ date('F d, Y h:i A', strtotime($log->isDispatchedTime)) }}
                                                            </p>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <p class="card-text mb-0">Date :
                                                                {{ date('F d, Y h:i A', strtotime($log->isArrivedTime)) }}
                                                            </p>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <p class="card-text mb-0">Date:
                                                                {{ date('F d, Y h:i A', strtotime($log->isTransferredTime)) }}
                                                            </p>
                                                            <p> </p>
                                                        </div>
                                                        <div class="col-lg-5 mt-lg-5 text-sm-end">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <p class="card-text mb-0">Date :
                                                                {{ date('F d, Y h:i A', strtotime($log->isAssortTime)) }}
                                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <h5 class="card-title border-0 fw-bold">YOUR ORDER IS
                                                                ALREADY BEEN PICKED UP BY LOGISTIC COMPANY</h5>
                                                            <p class="card-text mb-0">Date :
                                                                {{ date('F d, Y h:i A', strtotime($log->isPickUpTime)) }}
                                                            </p>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <p class="card-text mb-0">Date :
                                                                {{ date('F d, Y h:i A', strtotime($log->isProcessedTime)) }}
                                                            </p>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <p class="card-text mb-0">Date :
                                                                {{ date('F d, Y h:i A', strtotime($log->isPendingTime)) }}
                                                            </p>
                                                        </div>
                                                        <div class="col-lg-5 mt-lg-5 text-sm-end">
                                                            <p class="card-text mb-0">Company:</p>

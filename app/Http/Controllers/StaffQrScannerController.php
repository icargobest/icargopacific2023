...
class StaffQrScannerController extends Controller
{
    ...
    public function checkTnumber(Request $request)
{
    $result = 0;
    $status = null;
    $tracking_number = null;
    ...
    if ($request->tracking_number) {
        ...
        return response()->json([
            ...
            'isProcessedTime' => $isProcessedTime, 
            'isAssortTime' => $isAssortTime, 
            'isPickUpTime' => $isPickUpTime, 
            'isTransferredTime' => $isTransferredTime, 
            'isArrivedTime' => $isArrivedTime, 
            'isDispatchedTime' => $isDispatchedTime, 
            'isDeliveredTime' => $isDeliveredTime,
            'isPending' => $isPending, 
